-- CreateEnum
CREATE TYPE "BriefingStatus" AS ENUM ('RECEIVED', 'IN_ANALYSIS', 'PROPOSAL_SENT', 'IN_NEGOTIATION', 'APPROVED', 'IN_PROGRESS', 'DELIVERED');
...
CREATE TABLE "Briefing" (
    ...
    "hoursMin" INTEGER,
    "hoursMax" INTEGER,
    "status" "BriefingStatus" NOT NULL DEFAULT 'RECEIVED',
