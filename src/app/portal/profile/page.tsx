  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-16">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-slate-400">Gerencie as suas informações de contâcto.</p>
      </div>
      ...
      <div className="mb-6 grid grid-cols-2 gap-3">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
          ...
          <p className="text-xs text-slate-400 mt-0.5">Briefings</p>
        </div>
        <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-center">
      ...
      <div className="mt-8 rounded-2xl border border-white/10 bg-white/3 p-5">
        <h2 className="text-sm font-semibold text-slate-300 mb-1">Sessão</h2>
        <p className="text-xs text-slate-500 mb-3">Gestão de sessão ativa.</p>
        <Link
